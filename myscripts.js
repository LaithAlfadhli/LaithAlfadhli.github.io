...
function ClickHandle(a){
    ...
    if(a == 5) //if golden dive is clicked
    {
        ...
        document.getElementById("projectBlurb").innerHTML = "Tressure awaits for those brave enough to find it among the hordes of dangerous fish and mines.";
        console.log("Hello world!");
        document.getElementById("iframe").src = "videos\\The Golden Dive.mp4";
        document.getElementById("LinkProj").href  = "projects\\GoldenDive.html";
    }
    else if (a ==4)//if Physics 3D Racer is clicked
    {
        document.getElementById("projectName").innerHTML = "Physics 3D Racer";
        document.getElementById("projectBlurb").innerHTML = "It's simple, they said, it's easy. Just get from point A to B the fastest you can. Nothing can go wrong.";
        document.getElementById("iframe").src = "videos\\Racing.mp4";
        document.getElementById("LinkProj").href  = "projects\\Racing.html";
    ...
    else if (a ==3)//if TradeAB is clicked
    {
        ...
        document.getElementById("projectBlurb").innerHTML = "A website marketplace tutorial, place items on sale and bid your way to obtain them. Alternatively, outright buy them from other users.";
        document.getElementById("iframe").src = "videos\\TradeAB.mp4";
        document.getElementById("LinkProj").href  = "projects\\TradeAB.html";

    }
    else if (a ==2)//if WorldStats is clicked
    {
        document.getElementById("projectName").innerHTML = "WorldStats";
        document.getElementById("projectBlurb").innerHTML = "WorldStats is a quiz game that aims to teach its players about statistics and different parts of the world if they are inclined to explore.";
        document.getElementById("iframe").src = "videos\\WorldStats.mp4";
        document.getElementById("LinkProj").href  = "projects\\WorldStats.html";
    }
    else // in all other cases show the details for manastorm
    {
        document.getElementById("projectName").innerHTML = "Manastorm";
        document.getElementById("projectBlurb").innerHTML = "A multiplayer first-person spellcaster in which players work in teams to obliterate their enemies.";
        document.getElementById("iframe").src = "videos\\Manastorm.mp4";
        document.getElementById("LinkProj").href  = "projects\\Manastorm.html";
